...
REM
REM Generated by Vivado on Fri Dec 02 12:58:31 +0530 2022
...
echo "xvlog --incr --relax -prj ram64_8bit_tb_vlog.prj"
call xvlog  --incr --relax -prj ram64_8bit_tb_vlog.prj -log xvlog.log
